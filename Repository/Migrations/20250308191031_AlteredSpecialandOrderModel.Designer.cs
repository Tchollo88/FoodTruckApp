...
namespace FoodTruckApp.Migrations
{
    ...
    [Migration("20250308191031_AlteredSpecialandOrderModel")]
    partial class AlteredSpecialandOrderModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Models.Client.Customer", b =>
                {
            ...
            modelBuilder.Entity("Repository.Models.Menu.Ingredient", b =>
                {
            ...
            modelBuilder.Entity("Repository.Models.Menu.Order", b =>
                {
                    ...
                    b.HasIndex("Special_ID");

                    b.ToTable("Orders");
                });

            modelBuilder.Entity("Repository.Models.Menu.Purchase", b =>
                {
            ...
            modelBuilder.Entity("Repository.Models.Menu.Special", b =>
                {
                    b.Property<int>("Special_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Repository.Models.Menu.Ingredient", b =>
                {
                    b.HasOne("Repository.Models.Menu.MenuItem", null)
            ...
            modelBuilder.Entity("Repository.Models.Menu.Order", b =>
                {
                    b.HasOne("Repository.Models.Menu.Special", "Special")
                        .WithMany()
                        .HasForeignKey("Special_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Repository.Models.Menu.Receipt", b =>
                {
                    b.HasOne("Repository.Models.Client.Customer", "Customer")
                        .WithMany("Receipts")
                    ...
                    b.HasOne("Repository.Models.Menu.Purchase", "Purchase")
                        .WithMany()
